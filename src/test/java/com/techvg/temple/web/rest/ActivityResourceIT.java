...
class ActivityResourceIT {
    ...
    private static final byte[] DEFAULT_SIGNATURE_PHOTO = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_SIGNATURE_PHOTO = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_SIGNATURE_PHOTO_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_SIGNATURE_PHOTO_CONTENT_TYPE = "image/png";
    ...
    public static Activity createEntity(EntityManager em) {
        Activity activity = new Activity()
            ...
            .signaturePhoto(DEFAULT_SIGNATURE_PHOTO)
            .signaturePhotoContentType(DEFAULT_SIGNATURE_PHOTO_CONTENT_TYPE)
    ...
    public static Activity createUpdatedEntity(EntityManager em) {
        Activity activity = new Activity()
            ...
            .signaturePhoto(UPDATED_SIGNATURE_PHOTO)
            .signaturePhotoContentType(UPDATED_SIGNATURE_PHOTO_CONTENT_TYPE)
    ...
    void createActivity() throws Exception {
        ...
        assertThat(testActivity.getProfilePhoto()).isEqualTo(DEFAULT_PROFILE_PHOTO);
        assertThat(testActivity.getProfilePhotoContentType()).isEqualTo(DEFAULT_PROFILE_PHOTO_CONTENT_TYPE);
        assertThat(testActivity.getSignaturePhoto()).isEqualTo(DEFAULT_SIGNATURE_PHOTO);
        assertThat(testActivity.getSignaturePhotoContentType()).isEqualTo(DEFAULT_SIGNATURE_PHOTO_CONTENT_TYPE);
    ...
    void getAllActivities() throws Exception {
        ...
        restActivityMockMvc
            ...
            .andExpect(jsonPath("$.[*].signaturePhotoContentType").value(hasItem(DEFAULT_SIGNATURE_PHOTO_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].signaturePhoto").value(hasItem(Base64Utils.encodeToString(DEFAULT_SIGNATURE_PHOTO))))
    ...
    void getActivity() throws Exception {
        ...
        restActivityMockMvc
            ...
            .andExpect(jsonPath("$.signaturePhotoContentType").value(DEFAULT_SIGNATURE_PHOTO_CONTENT_TYPE))
            .andExpect(jsonPath("$.signaturePhoto").value(Base64Utils.encodeToString(DEFAULT_SIGNATURE_PHOTO)))
    ...
    void putExistingActivity() throws Exception {
        ...
        assertThat(testActivity.getProfilePhoto()).isEqualTo(UPDATED_PROFILE_PHOTO);
        assertThat(testActivity.getProfilePhotoContentType()).isEqualTo(UPDATED_PROFILE_PHOTO_CONTENT_TYPE);
        assertThat(testActivity.getSignaturePhoto()).isEqualTo(UPDATED_SIGNATURE_PHOTO);
        assertThat(testActivity.getSignaturePhotoContentType()).isEqualTo(UPDATED_SIGNATURE_PHOTO_CONTENT_TYPE);
