...
class DelegateResourceIT {
    ...
    private static final byte[] DEFAULT_PASSPORT_IMAGE = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_PASSPORT_IMAGE = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_PASSPORT_IMAGE_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_PASSPORT_IMAGE_CONTENT_TYPE = "image/png";
    ...
    private static final byte[] DEFAULT_FREE_FIELD_11 = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_FREE_FIELD_11 = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_FREE_FIELD_11_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_FREE_FIELD_11_CONTENT_TYPE = "image/png";

    private static final byte[] DEFAULT_FREE_FIELD_12 = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_FREE_FIELD_12 = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_FREE_FIELD_12_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_FREE_FIELD_12_CONTENT_TYPE = "image/png";
    ...
    public static Delegate createEntity(EntityManager em) {
        Delegate delegate = new Delegate()
            ...
            .profilePhotoContentType(DEFAULT_PROFILE_PHOTO_CONTENT_TYPE)
            .passportImage(DEFAULT_PASSPORT_IMAGE)
            ...
            .freeField11ContentType(DEFAULT_FREE_FIELD_11_CONTENT_TYPE)
            .freeField12(DEFAULT_FREE_FIELD_12)
            .freeField12ContentType(DEFAULT_FREE_FIELD_12_CONTENT_TYPE);
        return delegate;
    }
    ...
    public static Delegate createUpdatedEntity(EntityManager em) {
        Delegate delegate = new Delegate()
            ...
            .profilePhotoContentType(UPDATED_PROFILE_PHOTO_CONTENT_TYPE)
            .passportImage(UPDATED_PASSPORT_IMAGE)
            ...
            .freeField11ContentType(UPDATED_FREE_FIELD_11_CONTENT_TYPE)
            .freeField12(UPDATED_FREE_FIELD_12)
            .freeField12ContentType(UPDATED_FREE_FIELD_12_CONTENT_TYPE);
        return delegate;
    }
    ...
    void createDelegate() throws Exception {
        ...
        assertThat(testDelegate.getFirstName()).isEqualTo(DEFAULT_FIRST_NAME);
        assertThat(testDelegate.getLastName()).isEqualTo(DEFAULT_LAST_NAME);
        ...
        assertThat(testDelegate.getProfilePhoto()).isEqualTo(DEFAULT_PROFILE_PHOTO);
        assertThat(testDelegate.getProfilePhotoContentType()).isEqualTo(DEFAULT_PROFILE_PHOTO_CONTENT_TYPE);
        assertThat(testDelegate.getProfilePhotoContentType()).isEqualTo(DEFAULT_PROFILE_PHOTO_CONTENT_TYPE);
        assertThat(testDelegate.getPassportImage()).isEqualTo(DEFAULT_PASSPORT_IMAGE);
        ...
        assertThat(testDelegate.getFreeField11()).isEqualTo(DEFAULT_FREE_FIELD_11);
        assertThat(testDelegate.getFreeField11ContentType()).isEqualTo(DEFAULT_FREE_FIELD_11_CONTENT_TYPE);
        assertThat(testDelegate.getFreeField12()).isEqualTo(DEFAULT_FREE_FIELD_12);
        assertThat(testDelegate.getFreeField12ContentType()).isEqualTo(DEFAULT_FREE_FIELD_12_CONTENT_TYPE);
    }
    ...
    void getAllDelegates() throws Exception {
        ...
        restDelegateMockMvc
            ...
            .andExpect(jsonPath("$.[*].passportImage").value(hasItem(Base64Utils.encodeToString(DEFAULT_PASSPORT_IMAGE))))
            .andExpect(jsonPath("$.[*].passportImageContentType").value(hasItem(DEFAULT_PASSPORT_IMAGE_CONTENT_TYPE)))
            ...
            .andExpect(jsonPath("$.[*].freeField11ContentType").value(hasItem(DEFAULT_FREE_FIELD_11_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].freeField11").value(hasItem(Base64Utils.encodeToString(DEFAULT_FREE_FIELD_11))))
            .andExpect(jsonPath("$.[*].freeField12ContentType").value(hasItem(DEFAULT_FREE_FIELD_12_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].freeField12").value(hasItem(Base64Utils.encodeToString(DEFAULT_FREE_FIELD_12))));
    }
    ...
    void getDelegate() throws Exception {
        ...
        restDelegateMockMvc
            ...
            .andExpect(jsonPath("$.passportImage").value(Base64Utils.encodeToString(DEFAULT_PASSPORT_IMAGE)))
            .andExpect(jsonPath("$.passportImageContentType").value(DEFAULT_PASSPORT_IMAGE_CONTENT_TYPE))
            ...
            .andExpect(jsonPath("$.freeField11ContentType").value(DEFAULT_FREE_FIELD_11_CONTENT_TYPE))
            .andExpect(jsonPath("$.freeField11").value(Base64Utils.encodeToString(DEFAULT_FREE_FIELD_11)))
            .andExpect(jsonPath("$.freeField12ContentType").value(DEFAULT_FREE_FIELD_12_CONTENT_TYPE))
            .andExpect(jsonPath("$.freeField12").value(Base64Utils.encodeToString(DEFAULT_FREE_FIELD_12)));
    }
    ...
    @Test
    @Transactional
    void getAllDelegatesByFirstNameIsEqualToSomething() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where firstName equals to DEFAULT_FIRST_NAME
        defaultDelegateShouldBeFound("firstName.equals=" + DEFAULT_FIRST_NAME);

        // Get all the delegateList where firstName equals to UPDATED_FIRST_NAME
        defaultDelegateShouldNotBeFound("firstName.equals=" + UPDATED_FIRST_NAME);
    }

    @Test
    @Transactional
    void getAllDelegatesByFirstNameIsInShouldWork() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where firstName in DEFAULT_FIRST_NAME or UPDATED_FIRST_NAME
        defaultDelegateShouldBeFound("firstName.in=" + DEFAULT_FIRST_NAME + "," + UPDATED_FIRST_NAME);

        // Get all the delegateList where firstName equals to UPDATED_FIRST_NAME
        defaultDelegateShouldNotBeFound("firstName.in=" + UPDATED_FIRST_NAME);
    }

    @Test
    @Transactional
    void getAllDelegatesByFirstNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where firstName is not null
        defaultDelegateShouldBeFound("firstName.specified=true");

        // Get all the delegateList where firstName is null
        defaultDelegateShouldNotBeFound("firstName.specified=false");
    }

    @Test
    @Transactional
    void getAllDelegatesByFirstNameContainsSomething() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where firstName contains DEFAULT_FIRST_NAME
        defaultDelegateShouldBeFound("firstName.contains=" + DEFAULT_FIRST_NAME);

        // Get all the delegateList where firstName contains UPDATED_FIRST_NAME
        defaultDelegateShouldNotBeFound("firstName.contains=" + UPDATED_FIRST_NAME);
    }

    @Test
    @Transactional
    void getAllDelegatesByFirstNameNotContainsSomething() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where firstName does not contain DEFAULT_FIRST_NAME
        defaultDelegateShouldNotBeFound("firstName.doesNotContain=" + DEFAULT_FIRST_NAME);

        // Get all the delegateList where firstName does not contain UPDATED_FIRST_NAME
        defaultDelegateShouldBeFound("firstName.doesNotContain=" + UPDATED_FIRST_NAME);
    }

    @Test
    @Transactional
    void getAllDelegatesByLastNameIsEqualToSomething() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where lastName equals to DEFAULT_LAST_NAME
        defaultDelegateShouldBeFound("lastName.equals=" + DEFAULT_LAST_NAME);

        // Get all the delegateList where lastName equals to UPDATED_LAST_NAME
        defaultDelegateShouldNotBeFound("lastName.equals=" + UPDATED_LAST_NAME);
    }

    @Test
    @Transactional
    void getAllDelegatesByLastNameIsInShouldWork() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where lastName in DEFAULT_LAST_NAME or UPDATED_LAST_NAME
        defaultDelegateShouldBeFound("lastName.in=" + DEFAULT_LAST_NAME + "," + UPDATED_LAST_NAME);

        // Get all the delegateList where lastName equals to UPDATED_LAST_NAME
        defaultDelegateShouldNotBeFound("lastName.in=" + UPDATED_LAST_NAME);
    }

    @Test
    @Transactional
    void getAllDelegatesByLastNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where lastName is not null
        defaultDelegateShouldBeFound("lastName.specified=true");

        // Get all the delegateList where lastName is null
        defaultDelegateShouldNotBeFound("lastName.specified=false");
    }

    @Test
    @Transactional
    void getAllDelegatesByLastNameContainsSomething() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where lastName contains DEFAULT_LAST_NAME
        defaultDelegateShouldBeFound("lastName.contains=" + DEFAULT_LAST_NAME);

        // Get all the delegateList where lastName contains UPDATED_LAST_NAME
        defaultDelegateShouldNotBeFound("lastName.contains=" + UPDATED_LAST_NAME);
    }

    @Test
    @Transactional
    void getAllDelegatesByLastNameNotContainsSomething() throws Exception {
        // Initialize the database
        delegateRepository.saveAndFlush(delegate);

        // Get all the delegateList where lastName does not contain DEFAULT_LAST_NAME
        defaultDelegateShouldNotBeFound("lastName.doesNotContain=" + DEFAULT_LAST_NAME);

        // Get all the delegateList where lastName does not contain UPDATED_LAST_NAME
        defaultDelegateShouldBeFound("lastName.doesNotContain=" + UPDATED_LAST_NAME);
    }
    ...
    void putExistingDelegate() throws Exception {
        ...
        Delegate testDelegate = delegateList.get(delegateList.size() - 1);
        assertThat(testDelegate.getFirstName()).isEqualTo(UPDATED_FIRST_NAME);
        assertThat(testDelegate.getLastName()).isEqualTo(UPDATED_LAST_NAME);
        ...
        assertThat(testDelegate.getProfilePhoto()).isEqualTo(UPDATED_PROFILE_PHOTO);
        assertThat(testDelegate.getProfilePhotoContentType()).isEqualTo(UPDATED_PROFILE_PHOTO_CONTENT_TYPE);
        assertThat(testDelegate.getProfilePhotoContentType()).isEqualTo(UPDATED_PROFILE_PHOTO_CONTENT_TYPE);
        assertThat(testDelegate.getPassportImage()).isEqualTo(UPDATED_PASSPORT_IMAGE);
        ...
        assertThat(testDelegate.getFreeField11()).isEqualTo(UPDATED_FREE_FIELD_11);
        assertThat(testDelegate.getFreeField11ContentType()).isEqualTo(UPDATED_FREE_FIELD_11_CONTENT_TYPE);
        assertThat(testDelegate.getFreeField12()).isEqualTo(UPDATED_FREE_FIELD_12);
        assertThat(testDelegate.getFreeField12ContentType()).isEqualTo(UPDATED_FREE_FIELD_12_CONTENT_TYPE);
    }
