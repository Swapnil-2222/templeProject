...
public class Activity implements Serializable {
    ...
    @Column(name = "signature_photo_content_type")
    private String signaturePhotoContentType;
    ...
    public Activity profilePhoto(byte[] profilePhoto) {
    ...
    public Activity profilePhotoContentType(String profilePhotoContentType) {
    ...
    public Activity signaturePhoto(byte[] signaturePhoto) {
        this.setSignaturePhoto(signaturePhoto);
        return this;
    }
    ...
    public String getSignaturePhotoContentType() {
        return this.signaturePhotoContentType;
    }

    public Activity signaturePhotoContentType(String signaturePhotoContentType) {
        this.signaturePhotoContentType = signaturePhotoContentType;
        return this;
    }

    public void setSignaturePhotoContentType(String signaturePhotoContentType) {
        this.signaturePhotoContentType = signaturePhotoContentType;
    }
    ...
    public String toString() {
        return "Activity{" +
            ...
            ", signaturePhoto='" + getSignaturePhoto() + "'" +
            ", signaturePhotoContentType='" + getSignaturePhotoContentType() + "'" +
            ", status='" + getStatus() + "'" +
