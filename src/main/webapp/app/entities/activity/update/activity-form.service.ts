...
type ActivityFormGroupContent = {
  ...
  profilePhoto: FormControl<ActivityFormRawValue['profilePhoto']>;
  profilePhotoContentType: FormControl<ActivityFormRawValue['profilePhotoContentType']>;
  signaturePhoto: FormControl<ActivityFormRawValue['signaturePhoto']>;
  signaturePhotoContentType: FormControl<ActivityFormRawValue['signaturePhotoContentType']>;
...
export class ActivityFormService {
  createActivityFormGroup(activity: ActivityFormGroupInput = { id: null }): ActivityFormGroup {
    ...
    return new FormGroup<ActivityFormGroupContent>({
      ...
      profilePhoto: new FormControl(activityRawValue.profilePhoto),
      profilePhotoContentType: new FormControl(activityRawValue.profilePhotoContentType),
      signaturePhoto: new FormControl(activityRawValue.signaturePhoto),
      signaturePhotoContentType: new FormControl(activityRawValue.signaturePhotoContentType),
